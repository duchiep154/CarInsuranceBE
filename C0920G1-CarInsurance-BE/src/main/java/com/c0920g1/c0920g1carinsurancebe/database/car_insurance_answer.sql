...
CREATE TABLE `answer` (
  ...
  `date_answer` varchar(255) NOT NULL,
  `id_question` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKco1pkchpedfpv4r4v3nkyxsx3` (`id_question`),
  KEY `FKsdj8jab9t00diflkysw22k7bv` (`user_id`),
  CONSTRAINT `FKco1pkchpedfpv4r4v3nkyxsx3` FOREIGN KEY (`id_question`) REFERENCES `question` (`id`),
  CONSTRAINT `FKsdj8jab9t00diflkysw22k7bv` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
